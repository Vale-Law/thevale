      ...
      <div className="px-6 lg:px-8 pt-14 pb-6 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <label className="text-xs text-[#8A8578] font-body">Sort by:</label>
            <select
              value={sort}
              onChange={(e) => setSort(e.target.value)}
              className="h-10 border border-[#E5E2DC] bg-white px-3 text-sm font-body text-[#111418] rounded-md outline-none focus:border-[#0a5dc2]"
            >
              {SORT_OPTIONS.map((o) => (
