    ...
    <div className="min-h-screen bg-[var(--ground)]">
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-8">
        <div className="max-w-[1100px] mx-auto">
          <p className="font-body font-medium text-[11px] leading-[18px] tracking-[0.12em] uppercase text-[var(--text-3)] mb-3">
            For the practice
          </p>
          <h1 className="font-serif text-[48px] lg:text-[64px] leading-[1.02] tracking-[-0.02em] text-[var(--text)] max-w-3xl">
            The front door.
          </h1>
      ...
      <AttorneyBeat heading="The fee goes to the firm.">
        <p>
          The door is <span className="font-body font-semibold text-[36px] leading-[40px] tracking-[-0.02em] tabular-nums text-[var(--text)] align-middle">$199</span> a month. The consult fee goes to the firm. There is no per-booking cut and no pay-per-lead auction. First month free for the first five Houston firms.
        </p>
      </AttorneyBeat>
      ...
      <section className="py-16 lg:py-20 px-6 lg:px-8 bg-[var(--accent)]">
        <div className="max-w-[900px] mx-auto text-center">
          <h2 className="font-serif text-3xl sm:text-4xl leading-[1.15] tracking-[-0.01em] text-[var(--accent-on)] mb-5">
            Claim your booking page.
          </h2>
          <p className="font-body font-semibold text-[36px] leading-[40px] tracking-[-0.02em] tabular-nums text-[var(--accent-on)] mb-3">$199</p>
