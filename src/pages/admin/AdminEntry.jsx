 ...
 * user could set their own profiles.role to 'admin') was removed in Wave 0
 * of the 2026-08-15 money-loop audit. Admin is now granted only by a
 * service-role SQL migration (supabase/migrations/20260816000100), and the
 * protect_profiles_role trigger rejects the old client-side write outright.
 *
    ...
    <div className="min-h-screen bg-[var(--ground)] flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-sm text-[var(--text-3)] ds-type-body-m leading-relaxed">
          ...
          operations team — if you believe you should have it, contact support.
        </p>
      </div>
    </div>
  );
