  ...
  if (!isMobile) {
    ...
    return (
      <>
        ...
        <div
          className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[2100] bg-[var(--ground)] flex flex-col"
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          />
          <motion.div
            className="fixed bottom-0 left-0 right-0 z-[2100] bg-[var(--ground)] flex flex-col"
          ...
          >
            <div className="flex justify-center pt-3 pb-1.5 shrink-0 cursor-grab active:cursor-grabbing">
              <div className="w-10 h-1.5 rounded-full bg-[var(--line-2)]" />
            </div>
