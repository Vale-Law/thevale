    ...
    <div className="max-w-xl mx-auto">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8 pb-5 border-b border-[#E5E2DC]">
        <div>
          ...
          <h1 className="font-serif text-2xl sm:text-3xl text-[#111418]">
            {rejected ? 'Application not approved' : 'Application under review'}
          </h1>
        </div>
      </div>

      <div className="bg-white border border-[#E5E2DC] p-6 sm:p-8">
        {rejected ? (
          <>
            <div className="w-14 h-14 rounded-full bg-destructive/10 flex items-center justify-center mb-5">
              <XCircle className="w-7 h-7 text-destructive" />
            </div>
            <p className="text-sm text-[#8A8578] font-body leading-relaxed mb-6">
          ...
          <>
            <div className="w-14 h-14 rounded-full bg-[#EAF2FB] flex items-center justify-center mb-5">
              <Clock className="w-7 h-7 text-[#0a5dc2]" />
            </div>
            <h2 className="font-serif text-xl text-[#111418] mb-2">Thanks for applying to Brief!</h2>
            <p className="text-sm text-[#8A8578] font-body leading-relaxed mb-2">
        ...
        {attorney && (
          <div className="bg-[#F7F8FA] border border-[#E5E2DC] p-5 mb-6">
            ...
            <p className="text-sm text-[#8A8578] font-body">Consultation fee: ${attorney.consult_fee}</p>
        ...
        {!rejected && (
          <div className="flex items-start gap-2.5 bg-[#EAF2FB] border-l-2 border-[#0a5dc2] px-4 py-3 mb-6">
            <AlertCircle className="w-4 h-4 text-[#0a5dc2] shrink-0 mt-0.5" />
        ...
        <Link
          to="/attorney/profile"
          className="inline-flex items-center gap-2 px-5 py-3 bg-[#111418] text-white text-sm font-body hover:bg-[#0a5dc2] transition-colors"
        >
